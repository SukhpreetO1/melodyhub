        ...
        <div className="container mb-3">
            <div className={`${div_name} sm:col-span-4`}>
                ...
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 mt-2">
                    <input type="text" name={name} id={id} className={`${className} block flex-1 border-0 bg-transparent p-3 placeholder:text-white sm:text-sm sm:leading-6`} placeholder={placeholder} value={value} onChange={onChange} onFocus={onChange} autoComplete="off" />
                </div>
